...
vicroty_img = pygame.image.load("img/Icons/victory.png").convert_alpha()
...
restart_btn = Button(window, 330, 120, restart_img, 120, 30)
...
while running:
    ...
    if game_over != 0:
        if game_over == 1:
            window.blit(vicroty_img, (250, 50))
        elif game_over == -1:
